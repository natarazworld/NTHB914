...
@NamedNativeQuery(name = "GET_ALL_POLICIES_TYPE",
                                             query="SELECT POLICYID,POLICYNAME,POLICYTYPE FROM INSURANCEPOLICY WHERE POLICYTYPE=?")
@NamedNativeQuery(name = "GET_ALL_POLICIES",
                                               query="SELECT * FROM INSURANCEPOLICY",
                                               resultClass = InsurancePolicy.class)
@NamedNativeQuery(name = "DELETE_POLICY_BY_ID",
											query="DELETE FROM INSURANCEPOLICY  WHERE POLICYID=:id")
